        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Curso>()
                .HasData(new List<Curso>(){
                    ...
                    new Curso(4, "Engenharia da Computação"),
                    new Curso(5, "Analises de Sistema"),
                });
            ...
            builder.Entity<Disciplina>()
                .HasData(new List<Disciplina>{
                    ...
                    new Disciplina(11, "Programação", 5, 4),
                    new Disciplina(12, "Programação", 5, 5)
                });

            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.Parse("01/01/2023")),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", DateTime.Parse("01/01/2023")),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", DateTime.Parse("01/01/2023")),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", DateTime.Parse("01/01/2023")),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", DateTime.Parse("01/01/2023")),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", DateTime.Parse("01/01/2023")),
                    new Aluno(7, 7, "Paulo", "José", "9874512", DateTime.Parse("01/01/2023"))
                });
